...
try:
    ...
    im1 = Image.open('pic/LCD_1inch28_1.jpg')
    im2 = Image.open('pic/LCD_1inch28_2.jpg')
    while True:
        disp.ShowImage(im1, True)
        disp.ShowImage(im2, False)
        im1, im2 = im2, im1
    ...
    # draw.text((74, 150), u"微雪电子", fill = "WHITE",font=Font3)
    ...
    # disp.ShowImage(im_r, True)
    # disp.ShowImage(im_r, False)
    # time.sleep(3)
